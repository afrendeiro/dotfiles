...
[ -r /home/afr/.byobu/prompt ] && . /home/afr/.byobu/prompt   #byobu-prompt#



# set PATH for cuda 11 installation
...
vclone(){  # pass a URL as argument
    ...
    git clone $1
    cd $NAME
    python -m virtualenv _venv_${NAME}
    source _venv_${NAME}/bin/activate
    pip install .
}
